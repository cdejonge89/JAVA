...
console.log("min is " + threeLevelTree.min())
// console.log("min recursive is " + threeLevelTree.minRecursive())
console.log("max is " + threeLevelTree.max())